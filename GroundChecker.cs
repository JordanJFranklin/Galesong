...
// Finds the slope/grade/incline angle of ground underneath a player drriver
public class GroundChecker : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (Player.physicsProperties.Grounded)
        {
            CheckGround(new Vector3(transform.position.x, transform.position.y + startDistanceFromBottom, transform.position.z));
        }
        else
        {
            groundSlopeAngle = 0;
